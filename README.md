About opentelemetry-instrumentation-pinecone-feedstock
======================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-instrumentation-pinecone-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-instrumentation-pinecone-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-instrumentation-pinecone
# for installing globally
pixi global install opentelemetry-instrumentation-pinecone
```
...
It is possible to list all of the versions of `opentelemetry-instrumentation-pinecone` available on your platform:
...
```
pixi search opentelemetry-instrumentation-pinecone --channel conda-forge
```
